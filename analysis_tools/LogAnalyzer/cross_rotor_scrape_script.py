...
def main():
	...
	for i in range(len(new_data_points_1)):
		...
		if "ROTORCRAFT_FP" in line:
			...
			d_roll = float(d_val_list[9])*0.0000019						#DESIRED->roll (or phi)
			d_pitch = float(d_val_list[10])*0.0000019					#DESIRED->pitch (or theta)
			d_yaw = float(d_val_list[11])*0.0000019						#DESIRED->course (or Yaw/psi)
			d_x = float(d_val_list[12])*0.0039063 						#DESIRED->x
			d_y = float(d_val_list[13])*0.0039063						#DESIRED->y
			d_altitude = float(d_val_list[14]) * 0.0039063					#DESIRED->alt
			d_climb = float(d_val_list[8]) * 0.0000019					#DESIRED->climb
			d_airspeed = (abs(float(d_val_list[6])) + abs(float(d_val_list[7])))*0.0000019	#DESIRED->veast + DESIRED->vnorth
	...
	for i in range(len(new_data_points_2)):
		...
		if "ROTORCRAFT_FP" in line:
			...
			a_roll = float(d_val_list[9])*0.0000019						#DESIRED->roll (or phi)
			a_pitch = float(d_val_list[10])*0.0000019					#DESIRED->pitch (or theta)
			a_yaw = float(d_val_list[11])*0.0000019						#DESIRED->course (or Yaw/psi)
			a_x = float(d_val_list[12])*0.0039063 						#DESIRED->x
			a_y = float(d_val_list[13])*0.0039063						#DESIRED->y
			a_altitude = float(d_val_list[14]) * 0.0039063					#DESIRED->alt
			a_climb = float(d_val_list[8]) * 0.0000019					#DESIRED->climb
			a_airspeed = (abs(float(d_val_list[6])) + abs(float(d_val_list[7])))*0.0000019	#DESIRED->veast + DESIRED->vnorth
